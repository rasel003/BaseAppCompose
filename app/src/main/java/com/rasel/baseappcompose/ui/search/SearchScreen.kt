...
import com.rasel.baseappcompose.ui.utils.InterestsItem
...
fun EmptySearchResultBody(
    ...
    Column(
        ...
        val tryAnotherSearchString = buildAnnotatedString {
            append(stringResource(id = R.string.feature_search_try_another_search))
            append(" ")
            withLink(
                ...
                withStyle(
                    ...
                    append(stringResource(id = R.string.feature_search_interests))
                }
            }

            append(" ")
            append(stringResource(id = R.string.feature_search_to_browse_topics))
        }
        Text(
...
private fun SearchNotReadyBody() {
    Column(
        ...
        Text(
            text = stringResource(id = R.string.feature_search_not_ready),
            style = MaterialTheme.typography.bodyLarge,
            textAlign = TextAlign.Center,
            modifier = Modifier.padding(vertical = 24.dp),
        )
                    ...
                    Text(
                        text = buildAnnotatedString {
                            withStyle(style = SpanStyle(fontWeight = FontWeight.Bold)) {
                                append(stringResource(id = R.string.feature_search_topics))
                            }
                        },
            ...
            if (newsResources.isNotEmpty()) {
                item(
                    ...
                    Text(
                        text = buildAnnotatedString {
                            withStyle(style = SpanStyle(fontWeight = FontWeight.Bold)) {
                                append(stringResource(id = R.string.feature_search_updates))
                            }
                        },
                        modifier = Modifier.padding(horizontal = 16.dp, vertical = 8.dp),
                    )
                ...
                IconButton(
                    ...
                    Icon(
                        ...
                        contentDescription = stringResource(
                            id = R.string.feature_search_clear_recent_searches_content_desc,
                        ),
